		...
		<div class="sfooter-content">
			...
			<main class="main-fomrat">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-xs-3">Languages:</div>
						<div class="col-xs-9">PHP, CSS, HTML5, MySQL, JavaScript, Bootstrap, Angular, Pascal, Fortran, Forth, Cobol, and APL</div>
					</div>

					<div class="row">
						<div class="col-xs-3">Operating Systems:</div>
						<div class="col-xs-9">Windows (XP & 7),  MAC OS X Operating Systems (10.1.1 through Yosemite), and iOS (through 9.2)</div>
					</div>

					<div class="row">
						<div class="col-xs-3">Software:</div>
						<div class="col-xs-9">Microsoft Office, Google Chrome, Apple Safari, Mozilla Firefox Internet Explorer, Mozilla Firefox, Carbonite, PHPstorm, GitHub, Quicken, Blackboard Learn, Pearson Mastering, Learning Catalytics, iClicker, Socrative, Dreamweaver, Transana, Vernier Logger Pro, Pasco Data Studio, and Google applications</div>
					</div>
				...
				<div class="container">
					...
					<p>Intensive Practical Web Development Coding Certificate Program (Completed Dec 2015)</p>
					<ul>
						<li>
							<div>
								<p>Trained as a junior developer with both individual and team projects to code web applications from the backend, the frontend and connecting the two.  Languages: HTML5, CSS, JavaScript, MySQL, Bootstrap, and Angular.</p>
							</div>
						</li>
					</ul>

					<br>
					<h6>Dept. of Physics and Astronomy, University of New Mexico </h6>
					<p>(January 2009 - May 2015)</p>
					<ul>
						<li>
							<div>
								<p>Developed and managed class websites using Dreamweaver for introductory physics and astronomy classes including website for face-to-face and online astronomy lab class.</p>
							</div>
						</li>

						<li>
							<div>
								<p>Helped design and develop SCALE-UP-style active-learning studio classrooms and the Collaborative Teaching and Learning Building.</p>
							</div>
						</li>

						<li>
							<div>
								<p>Managed Astronomy Computer Lab.</p>
							</div>
						</li>

						<li>
							<div>
								<p>Used new technology in the classroom, including video analysis, next generation web-based homework systems, electronic classroom polling, and use of simulations both in class and as homework.  Also, evaluated the use of these systems for my department.</p>
							</div>
						</li>

						<li>
							<div>
								<p>Reviewed and wrote video scripts for Pearson Education online materials for introductory physics.</p>
							</div>
						</li>
					</ul>
